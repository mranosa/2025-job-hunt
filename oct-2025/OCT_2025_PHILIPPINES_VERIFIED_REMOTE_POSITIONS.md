# 🇵🇭 OCT 2025 PHILIPPINES-VERIFIED REMOTE SOFTWARE ENGINEERING POSITIONS
...
| Company | Position | Salary Range | Tech Stack | Application URL |
|---------|----------|--------------|------------|-----------------|
| **Buffer** | [Senior Backend Engineer (Platform & API)](https://buffer.com/journey/6febfd99-d236-48cf-8595-f7d4d0801ec9) | $156K-$202K + equity | Node.js, TypeScript, MongoDB, GraphQL, AWS | https://buffer.com/journey |
...
**Total Week 1:** 12 strategic applications
...
### **TIER 3 - STRATEGIC VOLUME (WEEKS 2-4):**
